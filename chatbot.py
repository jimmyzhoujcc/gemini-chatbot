...
class ChatBot:
    ...
    CHATBOT_NAME = "My Genmini AI Chatbot"
    ...
    def preload_conversation(self, conversation_history=None):
        if isinstance(conversation_history, list):
            ...
            self._conversation_history = [
                self._construct_message('system, You are a helpful assistant.'),
                self._construct_message('{"text": "Hello, how can I assist you today?"}' , 'model')
            ]
